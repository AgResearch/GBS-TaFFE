...
FID, = glob_wildcards("results/{fid}_kneaddata.fastq")
...
rule generateCentrifugeSampleSheet:
    ...
    threads:2
    shell:
        './workflow/scripts/generate_centrifuge_sample_sheet.sh -d results/02_kneaddata -p kneaddata.fastq -o {output.sampleSheet} '
