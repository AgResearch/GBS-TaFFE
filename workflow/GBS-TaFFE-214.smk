...
rule kraken2_GTDB214:
    ...
    shell:
        ...
        "--db /agr/scratch/projects/2022-bjp-gtdb/build-GTDB-DBs/GTDB214_Rambv3/kraken2-GTDB-214.1 " 
        "-t {threads} "
...
rule taxpasta_Kraken2_GTDB214_domain:
    ...
    shell:
        ...
        "-o {output} "
        "--output-format TSV "
        "--taxonomy /agr/scratch/projects/2022-bjp-gtdb/build-GTDB-DBs/GTDB214_Rambv3/kraken2-GTDB-214.1/taxonomy "
        "--add-name "
        "--add-rank "
        "--add-lineage "
        "--summarise-at domain "
...
rule kraken2_host_filter:
    ...
    shell:
        ...
        "--db /agr/scratch/projects/2022-bjp-gtdb/build-GTDB-DBs/GTDB214_Rambv3/kraken2-hosts " 
        "-t {threads} "
